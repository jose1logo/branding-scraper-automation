...
- **/get**: The bot will show buttons allowing you to choose which specific site to sync, or to sync all 4 at once.
- **Notifications**: You will receive a message automatically whenever the scheduled scrapes find new content.
